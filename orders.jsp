...
<%
	...
	try {
		...
		int i = st.executeUpdate(
				"insert into ORDERS(email,name,contact,address,ddate,dtime,item1,quantity1,item2,quantity2,item3,quantity3,item4,quantity4,item5,quantity5)values('"
						+ email + "','" + fname + "','" + cno + "','" + add + "','" + date + "','" + time
						+ "','" + i1 + "','" + q1 + "','" + i2 + "','" + q2 + "','" + i3 + "','" + q3 + "','"
						+ i4 + "','" + q4 + "','" + i5 + "','" + q5 + "')");
...
<%
	...
	try {
		...
		String htmlText = "<h2>Dear " + fname
				+ "!</h2><h3>Thank you for ordering via JMASK.</h3><h4>We'll send you tracking information when the order ships.</h4><img src=\"cid:image\" width=100px>";
